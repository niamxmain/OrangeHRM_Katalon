...
WebUI.verifyElementVisible(findTestObject('Admin_Menu/User_Management/Users/Add User/h6_Add User'))
...
WebUI.verifyElementVisible(findTestObject('Admin_Menu/User_Management/Users/Add User/div_Odis  Adalwin'))
